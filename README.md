# Camunda Platform 7 - The open source BPMN platform Support Spring Boot 3.0
...
How to use of maven:
1.Add repository in maven configuration file or pom.xml:
```
<repository>
  <id>github</id>
  <url>https://maven.pkg.github.com/ar-ming/camunda-bpm-platform</url>
  <snapshots>
